...
@section('dashboard-content')
    <div class="max-w-full mx-auto p-6">
        ...
        {{-- Form Start --}}
        <form action="{{ route('genarete.post') }}" method="POST">
            @csrf
            <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-200 overflow-hidden">
                ...
                <div class="p-8 md:p-10 border-b border-slate-100">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            class="absolute bottom-3 right-3 text-xs text-slate-400 font-medium bg-white/50 px-2 py-1 rounded">
                            Start typing...
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-50/50 p-8 md:p-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div x-data="{ open: false, selected: '', label: 'Select Platform' }" class="relative">
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Platform</label>
                            <input type="hidden" name="platform_id" x-model="selected" required>
                        ...
                        <div x-data="{ open: false, selected: '1', label: 'English (US)' }" class="relative">
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Language</label>
                            <input type="hidden" name="language_id" x-model="selected" required>
                        ...
                        <div x-data="{ open: false, selected: '', label: 'Select Tone' }" class="relative">
                            ...
                            <input type="hidden" name="tone_id" x-model="selected" required>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Output
                                LType</label>
                            {{-- Added Name: output_length --}}
                            <input type="text" name="output_length" placeholder="e.g. Short, Title"
