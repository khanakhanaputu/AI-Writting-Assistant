...
@section('content')
    ...
    <div class="min-h-screen relative flex flex-col items-center justify-center p-6 py-12 overflow-hidden bg-slate-50 font-sans"
        x-data="{
            mouseX: 0,
            mouseY: 0,
            handleMouseMove(e) {
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="mb-8 text-center relative z-10">
                ...
                <p class="text-slate-500 text-sm mt-3 font-medium">Start your AI writing journey today.</p>
            </div>
            ...
            <div
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-slate-500">Join thousands of creators writing with Glyphz.</p>
                </div>
                ...
                <form action="{{ route('register.store') }}" method="post" class="space-y-4">
                    ...
                    <div class="group/input">
                        <label class="text-xs font-bold text-slate-500 uppercase ml-1 mb-2 block tracking-wider">Full
                            Name</label>
                        <div class="relative">
                            <span
                            ...
                            <input type="text" name="name" placeholder="John Doe" required
                                class="w-full pl-11 pr-4 py-3.5 bg-white/50 border {{ $errors->has('name') ? 'border-rose-300 ring-2 ring-rose-50' : 'border-slate-200' }} rounded-2xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all text-sm font-medium placeholder-slate-400">
                        </div>
                    </div>

                    <div class="group/input">
                        <label class="text-xs font-bold text-slate-500 uppercase ml-1 mb-2 block tracking-wider">Email
                            Address</label>
                        <div class="relative">
                            <span
                                class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors">
                            ...
                            <input type="email" name="email" placeholder="name@example.com" required
                                class="w-full pl-11 pr-4 py-3.5 bg-white/50 border {{ $errors->has('email') ? 'border-rose-300 ring-2 ring-rose-50' : 'border-slate-200' }} rounded-2xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all text-sm font-medium placeholder-slate-400">
                        </div>
                    </div>
                    ...
                    <div class="group/input">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" placeholder="••••••••" required
                                class="w-full pl-11 pr-4 py-3.5 bg-white/50 border {{ $errors->has('password') ? 'border-rose-300 ring-2 ring-rose-50' : 'border-slate-200' }} rounded-2xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all text-sm font-medium placeholder-slate-400">
                        </div>
                    </div>

                    <div class="group/input">
                        <label class="text-xs font-bold text-slate-500 uppercase ml-1 mb-2 block tracking-wider">Confirm
                            Password</label>
                        <div class="relative">
                            <span
                                class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors">
                            ...
                            <input type="password" name="confirm_password" placeholder="••••••••" required
                                class="w-full pl-11 pr-4 py-3.5 bg-white/50 border border-slate-200 rounded-2xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all text-sm font-medium placeholder-slate-400">
                        </div>
                    </div>
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-[10px] uppercase font-bold tracking-widest">
                        <span class="bg-white/50 px-3 text-slate-400 backdrop-blur-sm rounded-full">Or sign up with</span>
                    </div>
                </div>
                ...
                <p class="text-center text-sm text-slate-500 mt-8">
                    ...
                    <a href="{{ route('login') }}"
                        class="font-bold text-indigo-600 hover:text-indigo-500 hover:underline transition-all">Sign In</a>
                </p>
            </div>
